...
def scan_directory(path="."):
            ...
            with open(contextignore_path, encoding='utf-8') as f:
                for line in f:
                    ...
                    if '*' in line or '?' in line:
                        ignore_patterns.add(line)  # file pattern
                    else:
                        ignore_folders.add(line.strip('/'))  # folder name
    ...
    for root, dirs, files in os.walk(path):
        ...
        for file in files:
            # skip context-pack output files
            if file in IGNORE_FILES:
                continue
            # skip files matching .contextignore patterns
